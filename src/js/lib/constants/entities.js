...
export const ENTITIES = [
    ...
    { type: ENTITIES_TYPE.COOK, family: ENTITIES_FAMILY.MODIFIERS, model: Cook, asset: ASSETS.COOK, animations: ANIMATIONS.COOK },
    ...
    { type: ENTITIES_TYPE.DRAGON, family: ENTITIES_FAMILY.MODIFIERS, model: Dragon, asset: ASSETS.DRAGON, animations: ANIMATIONS.DRAGON },
